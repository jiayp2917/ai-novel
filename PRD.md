...
**功能描述**
- 运行时统一识别新工作区结构：`content/settings`、`content/outlines`、`content/chapters`
- 历史 `00/01/02/03` 目录只作为迁移工具输入，不作为主应用自动兼容路径
- 工作区路径配置和状态检测
- 素材文件扫描和索引建立
- 作品档案扫描为 settings，例如 `content/settings/作品档案.md`

**用户流程**
1. 打开应用，确认当前工作区路径
2. 点击"重新扫描"，系统识别 `content/*` 素材目录
3. 左侧目录树显示设定、章纲、正文分卷
